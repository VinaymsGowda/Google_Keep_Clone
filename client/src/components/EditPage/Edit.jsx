...
export function Edit(){
    ...
    return(
        ...
        <form>
            <input className="editTitle" value={title} onChange={handleTitle}/><hr></hr>
            <textarea onChange={handleContent} value={content} style={{"width": "527px" ,"height": "96px"}}></textarea>
            <button type="submit" className="done" onClick={handleEdit}>Done</button>
        </form>
